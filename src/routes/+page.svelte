<script lang="ts">
  ...
  <section class="nav-page">
    <div class="animated-container" style={containerStyle}>
      <img
  ...
  <style>
    .nav-page {
      ...
      height: 100vh;
      background: linear-gradient(135deg, #e6e6fa, #d8bfd8); /* Soft purple gradient */
      overflow: hidden;
    ...
    .navigate-btn:active {
      ...
      background: #76448a; /* Even darker purple for click */
    }
